...
procedure ShowErrorMessage(format: WideString; hrErr: HRESULT);
...
// -------------------------------------------------------------------
procedure TMFPlaySample.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
//-------------------------------------------------------------------
procedure TMediaPlayerCallback.OnMediaPlayerEvent(pEventHeader: PMFP_EVENT_HEADER);
begin
...
procedure TMFPlaySample.menuExitClick(Sender: TObject);
begin
    Close;
end;
...
//-------------------------------------------------------------------
procedure TMFPlaySample.menuOpenClick(Sender: TObject);
var
    hr: HResult;
    lString: string;
